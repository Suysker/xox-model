...
- xox still owns product/domain behavior, action graph durable/product projection adapters, memory, sandbox, provider settings, final-response evidence classification, localized copy, and DTO projection through Agentic OS ports.

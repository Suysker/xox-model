...
import { getStageCostTotals, sumCostItems } from './costs.js'
import { scenarioMeta } from './scenarios.js'
...
export function isMemberActiveInMonth(member: TeamMember, monthIndex: number) {
...
export function getScenarioResult(config: ModelConfig, key: ScenarioKey): ScenarioResult {
  ...
  return {
    ...
    description: scenarioMeta[key].description,
    totalInvestment,
    totalEvents,

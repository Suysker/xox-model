...
function isEncryptedProviderApiKey(value: string) {
  return value.startsWith(`${ENCRYPTED_PREFIX}:`)
}

function encryptProviderApiKey(settings: Settings, apiKey: string) {
...
function decryptProviderApiKey(settings: Settings, storedApiKey: string) {

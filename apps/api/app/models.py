...
class ActualEntry(Base, TimestampMixin):
    ...
    source_entry_id: Mapped[str | None] = mapped_column(String(36), index=True)
    entry_origin: Mapped[str] = mapped_column(String(32), default="manual")
    derived_kind: Mapped[str | None] = mapped_column(String(32))
